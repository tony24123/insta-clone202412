<%-- src/main/webapp/WEB-INF/views/components/sidebar.jsp --%>
...
<nav class="sidebar">
  ...
  <div class="logo-container">
    <a href="/" class="logo">
      <svg aria-label="Instagram" class="_ab6-" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="29" role="img" viewBox="32 4 113 32" width="103">
  ...
  <div class="menu-container">
    ...
    <a href="/search" class="menu-item">
      ...
      <span class="menu-text">검색</span>
    </a>

    <a href="/explore" class="menu-item">
      <i class="fa-regular fa-compass"></i>
      <span class="menu-text">탐색 탭</span>
    </a>

    <a href="/reels" class="menu-item">
      <i class="fa-solid fa-film"></i>
      <span class="menu-text">릴스</span>
    </a>

    <a href="/direct/inbox" class="menu-item">
      <i class="fa-regular fa-paper-plane"></i>
      <span class="menu-text">메시지</span>
    </a>
  ...
  <div class="bottom-menu">
    <!-- Threads -->
    <a href="/threads" class="menu-item">
